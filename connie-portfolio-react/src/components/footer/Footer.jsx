   ...
   <footer className="footer">
    <div className="footer__container ">
        ...
        <div className="footer__social">
           <a href="https://www.instagram.com/connie_khalumba?igsh=NHdvY3U2bWJ6MXhw" className="footer__social-link" target="_blank" rel="noreferrer">
           <i className="fab fa-instagram"></i>
            </a>

           <a href="https://x.com/Connie9915?t=676rio4GeoRfjuBadKIm2w&s=09" className="footer__social-link" target="_blank" rel="noreferrer">
           ...
           &#169; Connie Khalumba. All rights reserved
           </span>
        </div>
    </div>
   </footer>
